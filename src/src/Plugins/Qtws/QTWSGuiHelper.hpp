...
#ifndef QTWSGUIHELPER_HPP
#define QTWSGUIHELPER_HPP
...
/*!
 */
class QTWSGuiHelper : public QObject {
  Q_OBJECT
  qtws_gui_rep* gui;

public:
  inline QTWSGuiHelper (qtws_gui_rep *_gui) : QObject (), gui (_gui) {}
