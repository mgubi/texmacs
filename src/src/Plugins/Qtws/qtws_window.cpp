...
#include "qtws_window.hpp"
#include "message.hpp"
#include "qtws_picture.hpp"
...
/******************************************************************************
* Creation and deletion of a qtws_window
******************************************************************************/

void
qtws_window_rep::set_hints (int min_w, int min_h, int max_w, int max_h) {
}
