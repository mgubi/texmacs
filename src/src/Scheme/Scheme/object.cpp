...
object::object (tmscm_object_rep* o) : tm_ptr<object_rep> (static_cast<object_rep*>(o)) {}
object::object () : tm_ptr<object_rep> (tm_new<tmscm_object_rep> (tmscm_null ())) {}
object::object (bool b) : tm_ptr<object_rep> (tm_new<tmscm_object_rep> (bool_to_tmscm (b))) {}
object::object (int i) : tm_ptr<object_rep> (tm_new<tmscm_object_rep> (int_to_tmscm (i))) {}
object::object (double x) : tm_ptr<object_rep> (tm_new<tmscm_object_rep> (double_to_tmscm (x))) {}
object::object (const char* s)
: tm_ptr<object_rep> (tm_new<tmscm_object_rep> (string_to_tmscm (string (s)))) {}
object::object (string s): tm_ptr<object_rep> (tm_new<tmscm_object_rep> (string_to_tmscm (s))) {}
object::object (tree t): tm_ptr<object_rep> (tm_new<tmscm_object_rep> (tree_to_tmscm (t))) {}
object::object (list<string> l)
  : tm_ptr<object_rep> (tm_new<tmscm_object_rep> (list_string_to_tmscm(l))) {}
object::object (list<tree> l)
: tm_ptr<object_rep> (tm_new<tmscm_object_rep> (list_tree_to_tmscm (l))) {}
