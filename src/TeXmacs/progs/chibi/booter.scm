...
|python:comment|
|python:constant|
|python:constant_char|
|python:constant_number|
|python:constant_string|
|python:declare_function|
|python:declare_type|
|python:error|
|python:keyword|
|python:keyword_conditional|
|python:keyword_control|
|python:none|
|python:operator|
|python:operator_field|
|python:operator_openclose|
|python:operator_special|
|quote|
|range|
|raster-resolution|
|raw|
...
|scale|
|scheme:comment|
|scheme:constant_char|
|scheme:constant_number|
|scheme:constant_string|
|scheme:declare_category|
|scheme:error|
|scheme:keyword|
|scheme:none|
|scheme:variable_identifier|
|script|
|scripts|
|secure|
|select|
