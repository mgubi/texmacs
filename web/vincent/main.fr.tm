...
<\body>
  ...
  <\abstract>
    <\with|par-mode|center>
      Diverses pistes dont il me paraît important d'exposer l'état.
    </with>
  </abstract>

  <section|Présentation des documents>

  Chaque page se termine par une section <with|font-series|bold|Aide
  Nécessaire> où l'on peut regarder comment participer à la stratégie.

  Les page sont en français. j'essaierai de traduire en anglais mais j'ai pas
  le temps.
